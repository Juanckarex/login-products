        ...
        {products.map((product) => (
          ...
          <SwiperSlide key={product.id}>
            <div className="card_1">
              ...
              <div className="card-subtitle">Category: {product.category}</div>
              <div className="card-subtitle"><p>{product.description}</p></div>
              <hr className="card-divider" />
              <div className="card-footer">
                <div className="card-price"><span>$</span> {product.price}</div>
                <div className="card-stock"><span>In stock:</span> {product.stock} units</div>
