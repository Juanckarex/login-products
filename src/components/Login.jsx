    ...
    return (
        <div>
            <form className="form" onSubmit={handLogin}>
                ...
                <input class="input" name="username" placeholder="Username" type="text" id="username" onChange={(e) => setUserName(e.target.value)}/>
                
                {/* <label class="input" htmlFor='password'>Password:</label> 
                <input type="password" id="password" onChange={(e) => setPassword(e.target.value)}/>*/}

                <input class="input" name="password" placeholder="Password" type="password" id="password" onChange={(e) => setPassword(e.target.value)}/>
